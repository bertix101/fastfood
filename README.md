...
```bash
  ...
  cd fastfood_deplyer/
  git clone https://github.com/bertix101/fastfood.git
```
...
```bash
    cd bertix101_fastfood_repo/fastfood/fastfood_BackEnd
    mvn clean package
```
...
```bash
    cd bertix101_fastfood_repo/fastfood/fastfood_FrontEnd
...
2. bertix101@utrains.test | Role : Admin | pwd : Bertix@101
3. alain@utrains.test | Role : Customer | pwd : Alain_p@ss
